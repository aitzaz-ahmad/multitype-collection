...
class property {
  public:
    ...
    template <class T> std::optional<T> get_as() const {
...
class configurations {
  public:
    ...
    template <class U> std::optional<U> get_value(const std::string& key) const {
    ...
    template <class U> std::optional<U> get_value(const property& config_property) const {
    ...
    template <class U> U get_value_or(const std::string& key, U default_value) const {
    ...
    template <class U> U get_value_or(const property& config_property, U default_value) const {
